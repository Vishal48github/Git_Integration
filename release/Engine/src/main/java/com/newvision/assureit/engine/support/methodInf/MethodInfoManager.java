 ...
 */
package com.newvision.assureit.engine.support.methodInf;

import com.newvision.assureit.datalib.component.TestStep;
import com.newvision.assureit.engine.support.AnnontationUtil;
import com.newvision.assureit.engine.support.reflect.Discovery;
...
public class MethodInfoManager {
    ...
    public static void load() {
        MethodExecutor.init();
        methodInfoMap.clear();
        AnnontationUtil.detect(ANNOTATION_DETECTOR, "com.newvision.assureit.engine.commands");
    }
