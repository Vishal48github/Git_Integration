...
public class ExtentSummaryHandler extends SummaryHandler implements PrimaryHandler {
    ...
    public void initiateExtentReport(String theme, String docTitle, String reportName)
        ...
        extentReport.sparkReporter.config().setCss(".side-nav-menu {background-color: url('/home/anshika/Documents/assureit-Dev/Engine/src/main/resources/reporting/logo.png'); }");
//        side-nav-menu
