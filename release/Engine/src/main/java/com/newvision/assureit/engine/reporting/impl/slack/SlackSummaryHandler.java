 ...
 */
package com.newvision.assureit.engine.reporting.impl.slack;
...
import com.newvision.assureit.notification.slack.Slack;
import java.io.File;
...
public class SlackSummaryHandler extends SummaryHandler implements PrimaryHandler {
    ...
    private static JSONObject common() {
        ...
        commonData.put("text", "*assureit Run Report*");
