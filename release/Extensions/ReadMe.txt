...
Chrome
========
1- assureit.crx file is used only for Test case debugging. Drag and drop .crx file on chrome browser is not supported.
...
1- Download the latest release from this GitHub link "https://github.com/newvisionQAHub/assureit-IE-Toolbar/releases" and install
...
1-Launch assureit and open either Spy,Heal or Recorder.
