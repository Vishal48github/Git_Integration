...
public class Har<K, V> extends JSONObject {
    ...
    public void addEntry(com.newvision.assureit.engine.reporting.performance.har.Entry e) {
        log.entries.add(e);
    }
    
    private com.newvision.assureit.engine.reporting.performance.har.Entry getPageEntry(Page p) {
        return new com.newvision.assureit.engine.reporting.performance.har.Entry(p);
    }
